...
OBJECTS += main.o
 ...
 SYS_OBJECTS += mbed/TARGET_KL25Z/TOOLCHAIN_GCC_ARM/except.o
 ...
 SYS_OBJECTS += mbed/TARGET_KL25Z/TOOLCHAIN_GCC_ARM/mbed_fault_handler.o
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1569502827.64
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1569502827.64
...
ASM_FLAGS += -I../MW_Camera
ASM_FLAGS += -I../MW_DC_Motor
ASM_FLAGS += -I../mbed
...
ASM_FLAGS += -include
ASM_FLAGS += /filer/workspace_data/exports/3/33f5a135d1fd1ea821909362d6aa2d84/NXP/mbed_config.h
ASM_FLAGS += -x
ASM_FLAGS += assembler-with-cpp
ASM_FLAGS += -c
ASM_FLAGS += -Wall
